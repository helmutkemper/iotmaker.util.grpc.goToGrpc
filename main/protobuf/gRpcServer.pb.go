...
var file_gRpcServer_proto_rawDesc = []byte{
	...
	0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x44, 0x61, 0x74, 0x61, 0x22, 0x2a, 0x0a, 0x14, 0x43,
	...
	0x0c, 0x52, 0x04, 0x44, 0x61, 0x74, 0x61, 0x22, 0x33, 0x0a, 0x1d, 0x43, 0x6f, 0x6e, 0x74, 0x61,
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x44, 0x61, 0x74, 0x61, 0x22, 0x36, 0x0a, 0x24,
...
var file_gRpcServer_proto_depIdxs = []int32{
	...
	89, // 29: iotmakerDockerCommunicationGrpc.DockerServer.ContainerInspectByNameContains:input_type -> iotmakerDockerCommunicationGrpc.ContainerInspectByNameContainsRequest
	...
	52, // 38: iotmakerDockerCommunicationGrpc.DockerServer.ContainerStop:input_type -> iotmakerDockerCommunicationGrpc.ContainerStopRequest
	53, // 39: iotmakerDockerCommunicationGrpc.DockerServer.ContainerStopAndRemove:input_type -> iotmakerDockerCommunicationGrpc.ContainerStopAndRemoveRequest
	54, // 40: iotmakerDockerCommunicationGrpc.DockerServer.ContainerWaitStatusNotRunning:input_type -> iotmakerDockerCommunicationGrpc.ContainerWaitStatusNotRunningRequest
	56, // 41: iotmakerDockerCommunicationGrpc.DockerServer.NetworkCreate:input_type -> iotmakerDockerCommunicationGrpc.NetworkCreateRequest
	58, // 42: iotmakerDockerCommunicationGrpc.DockerServer.NetworkFindIdByName:input_type -> iotmakerDockerCommunicationGrpc.NetworkFindIdByNameRequest
	42, // 43: iotmakerDockerCommunicationGrpc.DockerServer.NetworkList:input_type -> iotmakerDockerCommunicationGrpc.Empty
	61, // 44: iotmakerDockerCommunicationGrpc.DockerServer.NetworkRemove:input_type -> iotmakerDockerCommunicationGrpc.NetworkRemoveRequest
	62, // 45: iotmakerDockerCommunicationGrpc.DockerServer.NetworkRemoveByName:input_type -> iotmakerDockerCommunicationGrpc.NetworkRemoveByNameRequest
	...
	63, // 48: iotmakerDockerCommunicationGrpc.DockerServer.ImageBuildFromRemoteServer:input_type -> iotmakerDockerCommunicationGrpc.ImageBuildFromRemoteServerRequest
	66, // 49: iotmakerDockerCommunicationGrpc.DockerServer.ImageBuildFromRemoteServerStatus:input_type -> iotmakerDockerCommunicationGrpc.ImageOrContainerBuildPullStatusRequest
	68, // 50: iotmakerDockerCommunicationGrpc.DockerServer.ImageFindIdByName:input_type -> iotmakerDockerCommunicationGrpc.ImageFindIdByNameRequest
	42, // 51: iotmakerDockerCommunicationGrpc.DockerServer.ImageList:input_type -> iotmakerDockerCommunicationGrpc.Empty
	70, // 52: iotmakerDockerCommunicationGrpc.DockerServer.ImageListExposedPorts:input_type -> iotmakerDockerCommunicationGrpc.ImageListExposedPortsRequest
	72, // 53: iotmakerDockerCommunicationGrpc.DockerServer.ImageListExposedPortsByName:input_type -> iotmakerDockerCommunicationGrpc.ImageListExposedPortsByNameRequest
	74, // 54: iotmakerDockerCommunicationGrpc.DockerServer.ImageListExposedVolumes:input_type -> iotmakerDockerCommunicationGrpc.ImageListExposedVolumesRequest
	76, // 55: iotmakerDockerCommunicationGrpc.DockerServer.ImageListExposedVolumesByName:input_type -> iotmakerDockerCommunicationGrpc.ImageListExposedVolumesByNameRequest
	78, // 56: iotmakerDockerCommunicationGrpc.DockerServer.ImageMountNatPortList:input_type -> iotmakerDockerCommunicationGrpc.ImageMountNatPortListRequest
	80, // 57: iotmakerDockerCommunicationGrpc.DockerServer.ImageMountNatPortListChangeExposed:input_type -> iotmakerDockerCommunicationGrpc.ImageMountNatPortListChangeExposedRequest
	82, // 58: iotmakerDockerCommunicationGrpc.DockerServer.ImageMountNatPortListChangeExposedWithIpAddress:input_type -> iotmakerDockerCommunicationGrpc.ImageMountNatPortListChangeExposedWithIpAddressRequest
	84, // 59: iotmakerDockerCommunicationGrpc.DockerServer.ImagePull:input_type -> iotmakerDockerCommunicationGrpc.ImagePullRequest
	86, // 60: iotmakerDockerCommunicationGrpc.DockerServer.ImageRemove:input_type -> iotmakerDockerCommunicationGrpc.ImageRemoveRequest
	87, // 61: iotmakerDockerCommunicationGrpc.DockerServer.ImageRemoveByName:input_type -> iotmakerDockerCommunicationGrpc.ImageRemoveByNameRequest
	...
	90, // 74: iotmakerDockerCommunicationGrpc.DockerServer.ContainerInspectByNameContains:output_type -> iotmakerDockerCommunicationGrpc.ContainerInspectByNameContainsReply
	...
	51, // 82: iotmakerDockerCommunicationGrpc.DockerServer.ContainerStatisticsOneShotByName:output_type -> iotmakerDockerCommunicationGrpc.ContainerStatisticsOneShotByNameReply
	...
	57, // 86: iotmakerDockerCommunicationGrpc.DockerServer.NetworkCreate:output_type -> iotmakerDockerCommunicationGrpc.NetworkCreateReply
	59, // 87: iotmakerDockerCommunicationGrpc.DockerServer.NetworkFindIdByName:output_type -> iotmakerDockerCommunicationGrpc.NetworkFindIdByNameReply
	60, // 88: iotmakerDockerCommunicationGrpc.DockerServer.NetworkList:output_type -> iotmakerDockerCommunicationGrpc.NetworkListReply
	...
	64, // 93: iotmakerDockerCommunicationGrpc.DockerServer.ImageBuildFromRemoteServer:output_type -> iotmakerDockerCommunicationGrpc.ImageBuildFromRemoteServerReply
	67, // 94: iotmakerDockerCommunicationGrpc.DockerServer.ImageBuildFromRemoteServerStatus:output_type -> iotmakerDockerCommunicationGrpc.ImageOrContainerBuildPullStatusReply
	69, // 95: iotmakerDockerCommunicationGrpc.DockerServer.ImageFindIdByName:output_type -> iotmakerDockerCommunicationGrpc.ImageFindIdByNameReply
	88, // 96: iotmakerDockerCommunicationGrpc.DockerServer.ImageList:output_type -> iotmakerDockerCommunicationGrpc.ImageListReply
	71, // 97: iotmakerDockerCommunicationGrpc.DockerServer.ImageListExposedPorts:output_type -> iotmakerDockerCommunicationGrpc.ImageListExposedPortsReply
	73, // 98: iotmakerDockerCommunicationGrpc.DockerServer.ImageListExposedPortsByName:output_type -> iotmakerDockerCommunicationGrpc.ImageListExposedPortsByNameReply
	75, // 99: iotmakerDockerCommunicationGrpc.DockerServer.ImageListExposedVolumes:output_type -> iotmakerDockerCommunicationGrpc.ImageListExposedVolumesReply
	77, // 100: iotmakerDockerCommunicationGrpc.DockerServer.ImageListExposedVolumesByName:output_type -> iotmakerDockerCommunicationGrpc.ImageListExposedVolumesByNameReply
	79, // 101: iotmakerDockerCommunicationGrpc.DockerServer.ImageMountNatPortList:output_type -> iotmakerDockerCommunicationGrpc.ImageMountNatPortListReply
	81, // 102: iotmakerDockerCommunicationGrpc.DockerServer.ImageMountNatPortListChangeExposed:output_type -> iotmakerDockerCommunicationGrpc.ImageMountNatPortListChangeExposedReply
	83, // 103: iotmakerDockerCommunicationGrpc.DockerServer.ImageMountNatPortListChangeExposedWithIpAddress:output_type -> iotmakerDockerCommunicationGrpc.ImageMountNatPortListChangeExposedWithIpAddressReply
	85, // 104: iotmakerDockerCommunicationGrpc.DockerServer.ImagePull:output_type -> iotmakerDockerCommunicationGrpc.ImagePullReply
